...
# PLAY
scoreboard players remove @s faceRY 35
scoreboard players remove @s faceRX 10
...
execute @e[type=armor_stand,tag=slasherMarker,c=1] ~ ~ ~ particle crit ~ ~1 ~ 0.1 0.1 0.1 0 3
