...
function entity:slasher/actions/backup if @s[score_actionSelect_min=5,score_actionSelect=5]
...
function entity:slasher/actions/slash3 if @s[score_actionSelect_min=3,score_actionSelect=3]
