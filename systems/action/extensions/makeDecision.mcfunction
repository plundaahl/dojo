...
scoreboard players tag @e[score_comboSelect_min=0,score_comboSelect=0,score_actionSelect_min=0,score_actionSelect=0,score_actionTimer_min=0,score_actionTimer=0] add makeDecision
