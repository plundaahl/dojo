...
scoreboard players set @s[score_actionSelect_min=0,score_actionSelect=0,score_comboSelect=-1] comboSelect 0
scoreboard players set @s[score_actionSelect_min=0,score_actionSelect=0,score_comboSelect_min=1] comboSelect 0
